...
public static class LocalizationData
{
    public static readonly Dictionary<string, string> RU = new()
    {
        ...
        ["UI_MainMenu_Continue_Game"] = "Продолжить игру",
        ...
        ["MONOLOGUE_MORNING_DAY2_04"] = "Будешь плохо работать, неправильно классифицировать образцы — будешь уволен.",
    ...
    public static readonly Dictionary<string, string> EN = new()
    {
        ...
        ["MONOLOGUE_RETURN_01"] = "Receiving... We see from the cameras that you managed to collect the minerals — excellent!",
        ["MONOLOGUE_RETURN_02"] = "Now you need to analyze them — use the equipment at the base.",
        ["MONOLOGUE_RETURN_03"] = "Once you determine all characteristics of the sample — classify the mineral and send the report.",

        ["MONOLOGUE_FINAL_01"] = "Receiving... This is Command... we're detecting unusual readings from that sample too...",
        ["MONOLOGUE_FINAL_02"] = "Probably a scanner glitch! Don't worry — it happens.",
        ["MONOLOGUE_FINAL_03"] = "Just put the sample into the quarantine box and mark it as “Anomaly” in the report.",

        ["MONOLOGUE_MORNING_DAY2_01"] = "Receiving, this is Command. New cave coordinates uploaded, same protocol as yesterday.",
        ["MONOLOGUE_MORNING_DAY2_02"] = "Today's mission: four minerals. Samples that cannot be classified — mark as anomalies and place in the quarantine container.",
        ["MONOLOGUE_MORNING_DAY2_03"] = "Storm incoming, stay sharp. ::*;*%*?() good luck (*:.",
        ["MONOLOGUE_MORNING_DAY2_04"] = "Work poorly, misclassify samples — and you will be fired.",
        ...
        ["SCANNER_RECORD_DATA"] = "Record Oscillations",
