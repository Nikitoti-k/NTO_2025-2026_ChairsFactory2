...
public class TestTutorialManager : MonoBehaviour, ISaveableV2, IHasTutorialData, ILocalizable
{
    public static TestTutorialManager Instance { get; private set; }
    ...
    public void LoadTutorialSaveData(TutorialSaveData data)
    {
        ...
        if (step < hintKeys.Length)
        {
            bool shouldShow = step switch
            {
                ...
                1 => !moved,
                2 => !doorOpened,
                3 => flareHintActive && !data.hintShown_Flare,
                4 => !depositBroken,
                5 => !firstMineralPlaced,
                6 => !returnedHintShown,
                7 => !researchTableHintShown,
                8 => !scanMoveHintShown,
                9 => !scanClickHintShown,
                10 => !accuracyHintShown,
                11 => !showedFindTwoMore,
                12 => !conclusionHintShown,
                13 => !anomalyHintShown,
                14 => !bedHintShown,
                _ => true
            };
